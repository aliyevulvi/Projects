...
wire [15:0] out5;
wire [31:0] out6, out7, dm_addr, jump_addr, pc_next, out_swdec, out_swdec_mult;
...
//Control signals
wire regdest,alusrc,memtoreg,regwrite,memread,memwrite,branch,aluop1,aluop0, lwseq, swv, berr, balpos, signal_swdec;
...
if (memwrite_dm)
begin
datmem[dm_addr[4:0]+3]=out_swdec_mult[7:0];
datmem[dm_addr[4:0]+2]=out_swdec_mult[15:8];
datmem[dm_addr[4:0]+1]=out_swdec_mult[23:16];
datmem[dm_addr[4:0]]=out_swdec_mult[31:24];
end
...
// SWDEC
swdec_module swdecer(datab, out_swdec);

mult2_to_1_32 swdec_mult(out_swdec_mult, datab, out_swdec, signal_swdec);
...
aluop1,aluop0, lwseq, swv, berr, balpos, signal_swdec, instruc[5:0]);
...
"   REGISTER %h %h %h %h ",registerfile[8],registerfile[9], registerfile[10],registerfile[11], 
"   DATAMEM %h %h %h %h ",datmem[7],datmem[8],datmem[10],datmem[11]);
